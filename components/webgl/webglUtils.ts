...
export const generateBranchCurve = (start: Vector3, end: Vector3): CatmullRomCurve3 => {
    // P1: Sai do tronco. Usamos start.y direto pois o shader do tronco que o move visualmente.
    // Adicionamos offset em X para acompanhar o fluxo.
    ...
    const p3 = new Vector3(end.x - 1.0, end.y - 0.5, end.z);
